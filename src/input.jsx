    ...
    return (
      <div style={divStyle}>
        <form style={formStyle}>
          ...
          {this.state.input !== '' ? (
            <div style={divS}>
              <button value="X" className="fa fa-times" style={input2Style} onClick={this.clearText} tabIndex="0" type="button" />
              <button className="fa fa-search" style={inputSearch} onClick={this.search} tabIndex="0" type="button" />
            </div>
          )
            : <button className="fa fa-search hover" tabIndex="0" type="button" /> }
        </form>
      </div>
    );
  }
